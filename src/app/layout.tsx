...
export const metadata: Metadata = {
  title: "Grand Luxe Hotel - 5-Star Luxury Accommodation",
  description: "Experience unparalleled luxury at Grand Luxe Hotel. Premium accommodations, world-class amenities, and exceptional service in the heart of the city.",
  keywords: "luxury hotel, 5-star accommodation, premium rooms, spa, fine dining, business travel, romantic getaway",
  metadataBase: new URL("https://grandluxehotel.com"),
  alternates: {
    canonical: "https://grandluxehotel.com"
  },
  openGraph: {
    title: "Grand Luxe Hotel - 5-Star Luxury Accommodation",
    description: "Experience unparalleled luxury at Grand Luxe Hotel. Premium accommodations, world-class amenities, and exceptional service.",
    ...
    images: [{
      ...
      alt: "Grand Luxe Hotel luxury lobby interior"
    }],
    type: "website"
  },
  twitter: {
